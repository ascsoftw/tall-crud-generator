<div>
    <div x-data="{ selected: null}">
        ...
        <x:tall-crud-generator::accordion-wrapper x-ref="advancedTab2" x-bind:style="selected == 2 ? 'max-height: ' + $refs.advancedTab2.scrollHeight + 'px' : ''">
            ...
            <div class="mt-4">
                <x:tall-crud-generator::label>Validation Error:</x:tall-crud-generator::label>
                <x:tall-crud-generator::input type="text" class="mt-1 block w-1/2" wire:model.defer="flashMessages.text.validation_error" />
            </div>
        </x:tall-crud-generator::accordion-wrapper>
    </div>
</div>